...
$_SESSION['select']['triSelect'] = 'a.id desc';
...
$reqC = (!empty($_SESSION['select']['categorieSelect'])) ? 'AND a.categorie_id = '.$_SESSION['select']['categorieSelect'].' ' : '';
$reqR = (!empty($_SESSION['select']['regionSelect'])) ? 'AND a.region_id = '.$_SESSION['select']['regionSelect'].' ' : '';
$reqM = (!empty($_SESSION['select']['membreSelect'])) ? 'AND a.membre_id = '.$_SESSION['select']['membreSelect'].' ' : '';
...
.$reqC.$reqR.$reqM
// .$reqP
.' ORDER BY '. $_SESSION['select']['triSelect'];
